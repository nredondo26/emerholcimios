...
class ExternoController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    func cargardatos(zona : String){
        ...
        let url = URL(string: "http://appholcim.com/ccexterno.php")!
