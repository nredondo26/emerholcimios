//
//  InternoController.swift
//  emerholcim
//
//  Created by nerb2019 on 6/11/19.
//

import UIKit


class InternoController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    func cargardatos(zona : String){
        ...
        let url = URL(string: "http://appholcim.com/ccinterno.php")!
