...
class BrigadistasController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    func cargardatos(zona : String){
        ...
        let url = URL(string: "http://appholcim.com/ccbrigadistas.php")!
